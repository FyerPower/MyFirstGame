...
{
    Logger::log("Loading Shader: (%s)", shaderPath);
    int fileSize = 0;
    ...
    // Test if Shader compiled successfully
    {
        ...
        if (!success) {
            ...
            Logger::asssert(false, "Failed to compile Shaders %s", shaderLog);
            return 0;
        }
    }
...
bool gl_init(BumpAllocator* transientStorage)
{
    ...
    // Load the OpenGL Program and Shaders
...
void gl_render(BumpAllocator* transientStorage)
{
    ...
    // Game Tiles / Objects
    {
        ...
        // Set the active buffer and copy transforms into it
